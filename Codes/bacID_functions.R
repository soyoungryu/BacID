...
#id.paired: Top paired IDs for the model (Please ignore this.)
#id: two bacterial identifications (IDs for BacID)
...
matching_bi <- function(poly, ref,   true.id=NULL){
	m=2; mass.tolerance=2000
...
#int.sd: peak intensity variance
...
fit_model_C2 <- function(poly, monos, mass.tolerance=2000,
				...
				ini.alpha=NULL, esp=0.001, max.iter=100){ 
